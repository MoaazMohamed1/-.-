...
function createPostElement(post) {
    ...
    // إضافة الأزرار بجانب بعضها مع تغيير ترتيب الأزرار
    const buttonsDiv = document.createElement("div");
    buttonsDiv.classList.add("buttons-container");
    buttonsDiv.appendChild(deleteButton);  // حذف أولاً
    buttonsDiv.appendChild(editButton);   // تعديل ثانياً

    postDiv.appendChild(buttonsDiv);

    // إظهار زر التعديل عند الضغط على المنشور فقط
    postDiv.addEventListener("click", () => {
        editButton.style.display = "inline-block"; // إظهار زر التعديل عند الضغط
    });

    // إضافة المنشور في بداية القائمة (لإظهار الأحدث في الأعلى)
...
document.addEventListener("click", (event) => {
    // إخفاء زر التعديل عند الضغط خارج المنشور
